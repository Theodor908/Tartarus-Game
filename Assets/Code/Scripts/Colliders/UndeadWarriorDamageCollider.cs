...
namespace Tartarus
{
    public class UndeadWarriorDamageCollider : DamageCollider
    {
        ...
        protected override void DamageTarget(CharacterManager damageTarget)
        {
            ...
            damageEffect.angleOfDamage = Vector3.SignedAngle(aiCharacterCausingDamage.transform.forward, damageTarget.transform.forward, Vector3.up);
